    ...
    <StaticQuery
        ...
        render={data => (
            <React.Fragment>
                <div
                    id="departments"
                    className={'section ' + style.departments}
                >
                    <div className="container">
                        <div className="title">
                            <h2 className="underlined">Jurusan</h2>
                        </div>
                        <div className="contents">
                            <div className="row">{getContents(data)}</div>
                        </div>
                    </div>
                </div>
            </React.Fragment>
            ...
            <div className="department">
                ...
                <div className="description">
                    ...
                    <p className="font-2 middle">
                        <b>{props.item.node.frontmatter.title}</b>
                    </p>
                </div>
                <Link
                ...
                >
                    {props.item.node.frontmatter.title}
                </Link>
            </div>
        </div>
    );
